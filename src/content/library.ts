...
{t:"Silicone Coating",c:"metal",tier:3,d:"A fluid-applied roof coating known for strong resistance to ponding water and UV. Difficult to recoat (typically only with silicone) and slick when wet; common as a single-coat restoration over older single-ply or mod-bit roofs."},
{t:"Acrylic Coating",c:"metal",tier:3,d:"A water-based fluid-applied roof coating, the most affordable of the common coating chemistries. Reflective when white-pigmented and recoatable with itself, but degrades under chronic ponding water. Common cool-roof restoration coating for sloped low-slope assemblies that drain."},
{t:"Urethane Coating",c:"metal",tier:3,d:"A solvent- or water-based fluid-applied coating with strong abrasion and impact resistance. Often used as a base coat under silicone in two-coat systems, or as a stand-alone where heavy foot traffic is expected.",vf:1},
...
{t:"Wind Uplift Rating",c:"fire",tier:3,d:"A rated measure of how much uplift pressure a roof assembly can resist. FM ratings are written as I-60, I-90, I-120, I-180 — the number is the rated uplift pressure in pounds per square foot."},
{t:"Wind Zones (Field / Perimeter / Corner)",c:"fire",tier:3,d:"A low-slope roof is divided into three zones for wind-load design: the field (interior), the perimeter (a strip along edges), and the corners. Wind uplift is highest at corners, second-highest at perimeters, lowest in the field. Fastener density (or adhesive coverage) is increased in perimeters and corners to match. ASCE 7 defines the zone dimensions based on building size and design wind speed.",vf:1,see:["Wind Uplift","Wind Uplift Rating","ASCE 7","Factory Mutual (FM)"]},
...
{t:"Carlisle Gold Seal NDL",c:"claims",tier:3,d:"Carlisle SynTec's no-dollar-limit warranty for its single-ply roofing systems (Sure-Seal / Sure-White EPDM, Sure-Weld TPO, Sure-Flex PVC, FleeceBACK). Covers material and labor to repair leaks from manufacturing or workmanship defects with no dollar cap, for the warranty term (commonly 10–30 years depending on assembly spec, with the longest terms generally requiring fully adhered membrane and approved cover-board). Requires a Carlisle-authorized applicator and Carlisle components throughout. Ponding, abuse, foot-traffic damage, and storm damage are excluded.",vf:1,see:["Carlisle SynTec","EPDM","No Dollar Limit (NDL) Warranty","Fully Adhered","Mechanically Fastened","Ballasted Roof"]},
{t:"Red Shield NDL",c:"claims",tier:3,d:"Elevate's (formerly Firestone Building Products) no-dollar-limit warranty for its RubberGard EPDM, UltraPly TPO, and modified-bitumen roofing systems. Covers material and labor to repair leaks from manufacturing defects with no cap, for the warranty term (commonly up to 30 years on premium specifications). Requires an Elevate-licensed contractor and Elevate components throughout the assembly. Ponding, abuse, and storm damage excluded.",vf:1,see:["Elevate","EPDM","No Dollar Limit (NDL) Warranty","Fully Adhered","Mechanically Fastened"]},
{t:"Siplast NDL",c:"claims",tier:3,d:"Siplast's no-dollar-limit warranty for its SBS-modified-bitumen systems (Paradiene, Teranap, Veral) and built-up assemblies. Covers material and labor to repair leaks from manufacturing defects with no dollar cap, for the warranty term (commonly up to 20–30 years depending on the assembly and number of plies). Requires a Siplast-approved contractor and Siplast components throughout. Ponding, abuse, and storm damage excluded.",vf:1,see:["Siplast","SBS Modified Bitumen","Modified Bitumen","No Dollar Limit (NDL) Warranty"]},
{t:"Soprema NDL",c:"claims",tier:3,d:"Soprema's no-dollar-limit warranty for its SBS-modified-bitumen systems (Sopralast, Sopralene, Sopraply). Covers material and labor to repair leaks from manufacturing defects with no dollar cap, for the warranty term (commonly up to 20 years on standard specs and longer on enhanced multi-ply assemblies). Requires a Soprema-approved contractor and Soprema components throughout. Ponding, abuse, and storm damage excluded.",vf:1,see:["Soprema","SBS Modified Bitumen","No Dollar Limit (NDL) Warranty"]},
{t:"EPDM Attachment Methods (NDL Implications)",c:"claims",tier:3,d:"EPDM is unique among the common low-slope membranes in supporting ballasted, fully adhered, and mechanically fastened attachments — and each affects the NDL warranty differently. Fully adhered typically qualifies for the highest wind-uplift warranty rating. Mechanically fastened sits between. Ballasted is generally constrained to roofs ≤ ~2:12 slope with adequate structural capacity for the aggregate load, and is restricted or excluded in higher-wind zones. Term length, wind rating, and required cover-board all depend on the attachment plus approved components.",vf:1,see:["EPDM","Ballasted Roof","Fully Adhered","Mechanically Fastened","Carlisle Gold Seal NDL","Red Shield NDL"]},
{t:"Mod-Bit Application Methods (NDL Implications)",c:"claims",tier:3,d:"Modified bitumen supports four major application methods: hot-applied (mopped with hot asphalt), cold-process (cold adhesive), torch-applied (typically APP cap sheets), and self-adhered (factory adhesive backing). Within an NDL program, the chosen method changes the required assembly spec, the qualifying installer credential, and (in some programs) the available warranty term length. Torch-applied requires hot-work permits and torch-certified installers; cold-process is the typical choice where flame is restricted or for occupied buildings.",vf:1,see:["Modified Bitumen","SBS Modified Bitumen","APP Modified Bitumen","Cold-Process Roofing","Self-Adhered Membrane","Siplast NDL","Soprema NDL","JM Peak Advantage NDL"]},
...
{t:"Carlisle SynTec",c:"makers",tier:2,d:"A long-established single-ply roofing leader, producing EPDM (Sure-Seal / Sure-White), TPO (Sure-Weld), PVC (Sure-Flex), and FleeceBACK membrane systems. Its no-dollar-limit warranty program is the Carlisle Gold Seal NDL.",see:["Carlisle Gold Seal NDL","EPDM"]},
{t:"Elevate",c:"makers",tier:2,d:"The current brand for the former Firestone Building Products commercial roofing line, following Holcim's 2022 acquisition. Produces RubberGard EPDM, UltraPly TPO, and modified-bitumen systems. Its no-dollar-limit warranty program is the Red Shield NDL.",see:["Red Shield NDL","EPDM"]},
...
{t:"Owens Corning",c:"makers",tier:2,d:"A major North American building-products manufacturer whose roofing line includes the Duration and Oakridge architectural shingle families. Its extended residential warranty program is Platinum Protection (available through Platinum Preferred Contractors).",see:["OC Platinum Protection"]},
{t:"CertainTeed",c:"makers",tier:2,d:"A North American building-products manufacturer (Saint-Gobain) whose residential roofing line includes Landmark and Presidential shingle families. Its extended warranty programs include SureStart, SureStart Plus, and the Integrity Roof System.",see:["CertainTeed SureStart Plus"]},
{t:"IKO",c:"makers",tier:2,d:"A North American shingle manufacturer with the Cambridge and Dynasty architectural shingle lines. Its extended warranty program is ShieldPro Plus (available through ROOFPRO contractors).",see:["IKO ShieldPro Plus"]},
{t:"GAF Golden Pledge",c:"claims",tier:3,d:"GAF's highest-tier residential shingle warranty, requiring a Master Elite certified contractor and a full GAF-system install (shingles + matched starter, ridge cap, underlayment, ventilation, and IR Class 4 components as applicable). Covers shingles, accessories, and workmanship for the term. Mid-tier is Silver Pledge; entry-tier is System Plus. Verify current published terms before quoting.",vf:1,see:["GAF","Asphalt Shingle"]},
{t:"OC Platinum Protection",c:"claims",tier:3,d:"Owens Corning's highest-tier residential warranty, requiring a Platinum Preferred Contractor and a complete OC-system install. Covers shingles plus accessories and workmanship; lower tiers (Preferred and Standard) carry shorter coverage and fewer included components. Verify current published terms before quoting.",vf:1,see:["Owens Corning","Asphalt Shingle"]},
{t:"CertainTeed SureStart Plus",c:"claims",tier:3,d:"CertainTeed's extended residential warranty available through its credentialed contractor program (e.g., SELECT ShingleMaster). Adds workmanship coverage and a longer non-prorated period to the underlying lifetime limited shingle warranty. The Integrity Roof System designation requires installation of a CertainTeed-matched components package. Verify current published terms before quoting.",vf:1,see:["CertainTeed","Asphalt Shingle"]},
{t:"IKO ShieldPro Plus",c:"claims",tier:3,d:"IKO's extended residential warranty, available through its ROOFPRO contractor network. Adds workmanship and accessory coverage beyond the standard limited lifetime shingle warranty. Requires a complete IKO-system install with matched starter, ridge, underlayment, and ventilation. Verify current published terms before quoting.",vf:1,see:["IKO","Asphalt Shingle"]},
...
/* ===== Claims & Compliance — Code zone additions ===== */
{t:"Deductible",c:"claims",tier:2,d:"The amount the policyholder pays before insurance coverage applies, set either as a flat dollar figure or, on many storm-prone policies, as a percentage of the dwelling coverage. Percentage deductibles for wind/hail can be substantially larger than the standard all-perils deductible.",n:"Confirm whether the policy carries a separate wind/hail or named-storm deductible before quoting the owner's out-of-pocket — the surprise is often four to five figures."},
{t:"Non-Recoverable Depreciation",c:"claims",tier:3,d:"The portion of depreciation the policyholder will never recover, regardless of whether repairs are completed. Set by policy type (an ACV-only policy depreciates and never repays it) or by line-item rules in the carrier's estimating system.",see:["Recoverable Depreciation","Depreciation"]},
{t:"Proof of Loss",c:"claims",tier:3,d:"A sworn, written statement of the loss the policyholder submits to the carrier under most property policies. Many policies require it within 60 days of carrier request and treat untimely filing as a coverage defense.",vf:1,n:"The deadline runs from the carrier's request, not the loss date — diary it the day the request letter arrives."},
{t:"Reservation of Rights",c:"restoration",tier:3,d:"A carrier letter stating it will investigate or pay under a claim while preserving its right to later deny coverage. Triggers heightened documentation discipline; do not treat ROR as approval.",vf:1},
{t:"Field Adjuster",c:"claims",tier:2,d:"The adjuster who physically inspects the roof and writes the initial damage scope. May be a carrier staff adjuster or an independent contracted by the carrier; the carrier's name on the file does not always match who climbs the ladder.",see:["Adjuster"]},
{t:"Desk Adjuster",c:"claims",tier:2,d:"The adjuster who handles the file remotely from a desk, working from the field adjuster's photos, estimate, and notes. Makes the coverage and payment decisions on most non-catastrophe claims.",see:["Adjuster"]},
{t:"Independent Adjuster",c:"claims",tier:2,d:"An adjuster contracted by the carrier (not a direct employee) to handle claims, particularly during catastrophe surges. Paid per file or per hour; carries the carrier's authority on the inspection.",vf:1,see:["Adjuster"]},
{t:"Assignment of Benefits (AOB)",c:"restoration",tier:3,d:"A contract assigning the policyholder's claim rights to a contractor or vendor, letting them invoice and litigate the carrier directly. Heavily regulated and, in some states, restricted or banned outright after abuse.",vf:1,n:"Florida and Texas have substantially restricted AOB usage; verify state law before drafting one."},
{t:"Statute of Limitations (Property Claims)",c:"restoration",tier:3,d:"The state-specific deadline for filing suit on a property-insurance claim. Typically two to five years from date of loss or denial; some states have shorter windows specifically for storm claims.",vf:1,n:"The clock can run from date of loss, date of denial, or the contract's separate suit-limitations clause — pull the policy and the state rule together."},
{t:"Storm-Restoration Solicitation Laws",c:"restoration",tier:2,d:"State and local rules governing door-to-door roofing solicitation after a declared storm: registration with the state, written contracts with rescission rights, prohibitions on rebating the deductible, and required disclosure language. Violations risk both criminal liability and unenforceable contracts.",vf:1,n:"The rebate-the-deductible offer is the textbook felony in most storm states; train crews to refuse it even when the homeowner asks for it."},
{t:"Roofing Contractor License",c:"restoration",tier:2,d:"The state or local credential required to perform roofing work for compensation. Some states license at the state level (FL, NC, OR), some at the city or county, and a handful have no roofing-specific license but enforce general contractor or registration rules.",vf:1,see:["Storm-Restoration Solicitation Laws"]},
{t:"Restoration Contractor vs Public Adjuster",c:"restoration",tier:2,d:"A restoration contractor performs the repair work and may discuss scope with the carrier; a public adjuster is a licensed insurance-claim representative who negotiates the claim itself. Crossing the line by acting as both is the most common storm-market regulatory violation.",vf:1,see:["Public Adjuster"]},
{t:"Examination Under Oath (EUO)",c:"restoration",tier:3,d:"A formal sworn examination of the policyholder the carrier may demand under most property policies, with a court reporter and the carrier's counsel present. Refusal is grounds for denial in most policies; counsel is advisable.",vf:1},
